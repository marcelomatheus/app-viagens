...
Viagem DeficoesViagem(Viagem viagemEndereco){
    Viagem viagem;
    srand((unsigned)time(NULL));
    ...
    if(viagem.distancia<=3){
        ...
        strcpy(viagem.destino,viagemEndereco.destino);
        strcpy(viagem.origem, viagemEndereco.origem);
...
Viagem CopiarDadosParaViagens(Motorista motorista, Passageiro passageiros, Viagem viagemDadosAnteriores){
    Viagem viagem;
    ...
    strcpy(viagem.destino,viagemDadosAnteriores.destino);
    strcpy(viagem.origem,viagemDadosAnteriores.origem);
    viagem.valor = viagemDadosAnteriores.valor;
    viagem.distancia = viagemDadosAnteriores.distancia;
    viagem.tempo = viagemDadosAnteriores.tempo;
...
void MenuViagens(){
    ...
    viagens = CopiarDadosParaViagens(motorista,passageiros,viagens); //Essa função passa dados do motorista e do passageiro para o struct viagens
